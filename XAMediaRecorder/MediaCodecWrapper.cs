...
namespace XAMediaRecorder
{
    ...
    public class MediaCodecWrapper
    {
     ...
     　  *
         ...
         */
        public bool WriteSample(ByteBuffer input, MediaCodec.CryptoInfo crypto,
            ...
            if (size > 0 && mAvailableInputBuffers.Any())
            {
                ...
                {
                    throw new WriteException(Java.Lang.String.Format(Locale.Us,
         ...
         * @throws MediaCodec.CryptoException
         */
        public bool WriteSample(MediaExtractor extractor, bool isSecure,
            long presentationTimeUs, int flags)
        {
            bool result = false;
